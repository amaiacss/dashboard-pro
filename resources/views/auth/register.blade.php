            ...
            <div class="container">
                ...
                <div class="account-box">
                    <div class="account-wrapper">
                        ...
                        <!-- Account Form -->
                        {{--  el action llama a la ruta web.php y busca la siguiente ruta con nombre register, será la que envía los datos al método 
                         storeUser del controlador RegisterController  --}}
